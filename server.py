...
SEED_JOKES = [
    ...
    ("Why can't you give Elsa a balloon? Because she'll let it go.", "dad jokes"),
    ("Did you hear about the guy who invented Lifesavers? He made a mint.", "dad jokes"),
    ("I only know 25 letters of the alphabet. I don't know why.", "dad jokes"),
    ("What do you call a dinosaur that crashes their car? Tyrannosaurus wrecks.", "dad jokes"),
    ("Spring is here! I got so excited I wet my plants.", "dad jokes"),
    ("What do you call a lazy kangaroo? A pouch potato.", "dad jokes"),
    ("Why did the math book look so sad? Because it had too many problems.", "dad jokes"),
    ("I tried to catch some fog earlier. I mist.", "dad jokes"),
    ("I used to be addicted to soap. But I'm clean now.", "dad jokes"),
    ("What's a skeleton's least favorite room? The living room.", "dad jokes"),
    ("Why don't eggs tell jokes? Because they'd crack each other up.", "dad jokes"),
    ("I ordered a chicken and an egg from Amazon. I'll let you know.", "dad jokes"),
    ("What do you call a pony with a cough? A little horse.", "dad jokes"),
    ("Why do cows wear bells? Because their horns don't work.", "dad jokes"),
    ("I know a lot of jokes about retired people. None of them work.", "dad jokes"),
    ("How do you organize a space party? You planet.", "dad jokes"),
    ("Did you hear about the claustrophobic astronaut? He just needed a little space.", "dad jokes"),
    ("I'm reading a horror story in Braille. Something bad is about to happen, I can feel it.", "dad jokes"),
    ("What do you call a fish without eyes? A fsh.", "dad jokes"),
    # ── TECH JOKES ─────────────────────────────────────────────────────────────
    ...
    ("There are 10 types of people: those who understand binary and those who don't.", "tech jokes"),
    ("A programmer's wife says: go get milk, if they have eggs get a dozen. He came home with 12 milks.", "tech jokes"),
    ...
    ("I changed my password to incorrect. Now when I forget it, it says: Your password is incorrect.", "tech jokes"),
    ("Debugging: being the detective in a crime movie where you're also the murderer.", "tech jokes"),
    ("The best thing about a Boolean is that even if you're wrong, you're only off by a bit.", "tech jokes"),
    ("Why was the JavaScript developer sad? He didn't Node how to Express himself.", "tech jokes"),
    ("A QA engineer walks into a bar. Orders 1 beer. Orders 0 beers. Orders -1 beers. Orders a lizard.", "tech jokes"),
    ...
    ("The cloud is just someone else's computer you're paying rent on.", "tech jokes"),
    ("Git commit -m Fixed everything. Narrator: he had not fixed everything.", "tech jokes"),
    ("Why did the programmer quit his job? Because he didn't get arrays.", "tech jokes"),
    ("What's a programmer's favorite hangout place? Foo Bar.", "tech jokes"),
    ("Why do Java developers wear glasses? Because they don't C#.", "tech jokes"),
    ("An SEO expert walks into a bar, bars, tavern, pub, public house, Irish pub, drinks, beer.", "tech jokes"),
    ("Why did the developer go to therapy? Too many unresolved issues.", "tech jokes"),
    ("What do you call 8 hobbits? A hobbyte.", "tech jokes"),
    ("Why was the computer cold? It left its Windows open.", "tech jokes"),
    ("My software never has bugs. It just develops random features spontaneously.", "tech jokes"),
    ("Why don't programmers like nature? It has too many bugs.", "tech jokes"),
    ("What's a computer's favorite snack? Microchips.", "tech jokes"),
    ("How many programmers does it take to change a light bulb? None, that's a hardware problem.", "tech jokes"),
    ("Why did the computer show up at work late? It had a hard drive.", "tech jokes"),
    ("What do computers eat when they're hungry? Cookies.", "tech jokes"),
    ("A byte walks into a bar looking pale. The bartender asks: What's wrong? He says: I had a bit of a bad day.", "tech jokes"),
    ("Why did the programmer go broke? He cleared his cache.", "tech jokes"),
    ("What do you call a programmer from Finland? Nerdic.", "tech jokes"),
    ("Why was the cell phone wearing glasses? Because it lost all its contacts.", "tech jokes"),
    # ── RELATIONSHIP JOKES ─────────────────────────────────────────────────────
    ("My wife told me I had to stop acting like a flamingo. I had to put my foot down.", "relationship jokes"),
    ("Our relationship is like a software update. I never know when it's happening and it takes forever.", "relationship jokes"),
    ("I love you more than coffee. Please don't make me prove it.", "relationship jokes"),
    ("My partner said I never listen. At least I think that's what they said.", "relationship jokes"),
    ("Marriage is like a deck of cards. Start with hearts and diamonds. End wanting clubs and spades.", "relationship jokes"),
    ("I love being married. Great to find that one special person you want to annoy forever.", "relationship jokes"),
    ("Behind every great man is a woman rolling her eyes.", "relationship jokes"),
    ("I asked my wife what she wanted for her birthday. She said nothing would make her happier than diamonds. So I got her nothing.", "relationship jokes"),
    ("Relationships are like algebra. Have you ever looked at your X and wondered Y?", "relationship jokes"),
    ...
    ("We have a simple rule: I make the small decisions, she makes the big ones. In 30 years, no big decisions yet.", "relationship jokes"),
    ("My husband said he needed more space. So I locked him outside.", "relationship jokes"),
    ("Before marriage a man yearns for the woman he loves. After marriage the Y becomes silent.", "relationship jokes"),
    ("Love is one long sweet dream. Marriage is the alarm clock.", "relationship jokes"),
    ("I asked my wife if she ever fantasizes about me. She said yes, about me doing the dishes.", "relationship jokes"),
    ("My wife asked me to stop singing Wonderwall. I said maybe.", "relationship jokes"),
    ("My wife and I decided we don't want children. We're telling them tomorrow.", "relationship jokes"),
    ("My wife is a magician. She turns everything I say into an argument.", "relationship jokes"),
    ("I wrote my wife a love letter. She highlighted all my spelling mistakes.", "relationship jokes"),
    ("My wife told me I was immature. I told her to get out of my fort.", "relationship jokes"),
    ("I gave my wife a gift and she said nothing. That's how I knew she loved it.", "relationship jokes"),
    ("I told my girlfriend she should embrace her mistakes. She gave me a hug.", "relationship jokes"),
    ("I bought my wife a mood ring. Good mood: green. Bad mood: red mark on my forehead.", "relationship jokes"),
    ("My wife and I always hold hands. If I let go, she shops.", "relationship jokes"),
    ("I told my wife the truth: I was at my friend's place. She followed me. Nobody was there.", "relationship jokes"),
    ("My girlfriend said she wanted to feel like a princess. So I made her sit in a tower.", "relationship jokes"),
    ("My wife and I had a perfect understanding. I don't try to run her life, she doesn't try to run mine.", "relationship jokes"),
    ("I'm at the age where I need glasses to find my glasses.", "relationship jokes"),
    ("My wife said I needed to be more in touch with my feelings. So I got angry and told her.", "relationship jokes"),
    ("Sometimes I look at my husband and think, wow, I really won the argument lottery.", "relationship jokes"),
    # ── ABSURD HUMOR ───────────────────────────────────────────────────────────
    ("I asked the universe for a sign. It sent me a stop sign. Still not sure what it means.", "absurd humor"),
    ("Existence is just the universe debugging itself. We are all unresolved stack traces.", "absurd humor"),
    ...
    ("I have a joke about paper. It's tearable.", "absurd humor"),
    ("I was going to tell a time-traveling joke, but you didn't like it.", "absurd humor"),
    ("How do you make holy water? You boil the hell out of it.", "absurd humor"),
    ("My dog ate all the Scrabble tiles. He keeps leaving messages around the house.", "absurd humor"),
    ("What's brown and sticky? A stick.", "absurd humor"),
    ("I tried writing with a broken pencil. It was pointless.", "absurd humor"),
    ("Velcro: what a rip-off.", "absurd humor"),
    ("I slept like a log last night. Woke up in the fireplace.", "absurd humor"),
    ("I'm writing a book about reverse psychology. Please don't read it.", "absurd humor"),
    ("Some people think I'm addicted to somersaults. That's just how I roll.", "absurd humor"),
    ("I asked my dog what 2 minus 2 is. He said nothing.", "absurd humor"),
    ("What do you call a boomerang that doesn't come back? A stick.", "absurd humor"),
    ("I have many jokes about unemployed people. Sadly, none of them work.", "absurd humor"),
    ("I'm not arguing, I'm just explaining why I'm right.", "absurd humor"),
    ("Why can't you hear a pterodactyl going to the bathroom? Because the P is silent.", "absurd humor"),
    ("I'm reading a book on the history of glue. I can't put it down.", "absurd humor"),
    ("What do you call a sleeping dinosaur? A dino-snore.", "absurd humor"),
    ("I was addicted to the hokey pokey but I turned myself around.", "absurd humor"),
    ("I like to hold doors open for old people. It makes me feel like a wizard.", "absurd humor"),
    ("My wife told me I had to stop acting like a penguin. I was devastated. Had to waddle it off.", "absurd humor"),
    ("I asked God for a sign. A bus splashed me. Close enough.", "absurd humor"),
    # ── DARK HUMOR ─────────────────────────────────────────────────────────────
    ("I have a fish that can breakdance. Only for 20 seconds though, and only once.", "dark humor"),
    ("I told my psychiatrist I was hearing voices. He told me I don't have a psychiatrist.", "dark humor"),
    ("My grandfather has the heart of a lion and a lifetime ban from the zoo.", "dark humor"),
    ("I have a joke about trickle-down economics, but 99% of you will never get it.", "dark humor"),
    ("Dark humor is like food. Not everyone gets it.", "dark humor"),
    ("I was wondering why the frisbee was getting bigger. Then it hit me.", "dark humor"),
    ("The cemetery is so crowded. People are just dying to get in there.", "dark humor"),
    ("I threw a boomerang a few years ago. I now live in constant fear.", "dark humor"),
    ("Welcome to Plastic Surgery Addicts Anonymous. I see a lot of new faces today.", "dark humor"),
    ("My parents raised me as an only child, which was tough on my brother.", "dark humor"),
    ("My doctor said I only have 12 months to live. I'm not paying his bill.", "dark humor"),
    ("I got a new pair of gloves. Both are lefts. On one hand great, on the other just not right.", "dark humor"),
    ("Light travels faster than sound. That's why some people appear bright until they speak.", "dark humor"),
    ("I haven't slept for ten days because that would be too long.", "dark humor"),
    ("I told my doctor I broke my arm in two places. He told me to stop going to those places.", "dark humor"),
    ("People who take care of chickens are literally chicken tenders.", "dark humor"),
    ("I have a lot of growing up to do. I realized that inside my fort.", "dark humor"),
    ("I'm at the age where my back goes out more than I do.", "dark humor"),
    ("I used to think I was indecisive. Now I'm not so sure.", "dark humor"),
    ("Don't you hate it when someone answers their own questions? I do.", "dark humor"),
    ("Why do we tell actors to break a leg? Because every play has a cast.", "dark humor"),
    ("My wife locked me in the cellar to get better with age. She was right.", "dark humor"),
    ("I'm not saying I'm Batman but has anyone ever seen me and Batman in the same room?", "dark humor"),
    ("I asked my boss for a raise because three companies are after me. He asked which ones. Gas, electric, and water.", "dark humor"),
    ("Behind every angry woman is a man with absolutely no idea what he did wrong.", "dark humor"),
    ("I told my wife to embrace her mistakes. She gave me a very long hug.", "dark humor"),
    ("Why did the bicycle fall over? Because it was two-tired.", "dark humor"),
    ("I failed my scuba diving exam. I think I got the bends.", "dark humor"),
    ("My boss told me I have a problem with authority. I said the problem is he doesn't understand it.", "dark humor"),
    ("I always wanted to be a doctor but I didn't have the patients.", "dark humor"),
    ("My problem is that I think I'm funny and nobody agrees. Well, almost nobody. Thanks, Mom.", "dark humor"),
    ("Death is hereditary.", "dark humor"),
    ("I'm writing my will. It's a dead giveaway.", "dark humor"),
    # ── WORK HUMOR ─────────────────────────────────────────────────────────────
    ...
    ("I always give 100% at work: 10% Monday, 23% Tuesday, 40% Wednesday, 22% Thursday, 5% Friday.", "work humor"),
    ...
    ("HR said focus on my strengths. So now I nap with confidence.", "work humor"),
    ...
    ("I pretend to work. They pretend to pay me. We're all happy.", "work humor"),
    ("I'm not procrastinating. I'm doing side quests.", "work humor"),
    ("My performance review said I need to work on communication. I was going to respond but couldn't find the words.", "work humor"),
    ("The best part of my job is that my chair spins.", "work humor"),
    ("I asked my boss if I could leave early. He said only if you make up the time. I said sure, it's 7:30pm.", "work humor"),
    ("Job interview tip: when they ask where you see yourself in 5 years, don't say napping.", "work humor"),
    ("I work hard so my dog can have a better life.", "work humor"),
    ("The only exercise I get at work is jumping to conclusions.", "work humor"),
    ("I told my boss I needed a mental health day. He said take all the time you need. I took the week.", "work humor"),
    ("Experience is what you get when you didn't get what you wanted.", "work humor"),
    ("I love deadlines. I love the whooshing sound they make as they fly by.", "work humor"),
    ("My job is secure. Nobody else wants it.", "work humor"),
    ("I'm not ignoring your emails. I'm allowing them to mature.", "work humor"),
    ("My boss asked why I was late. I said because of a sign. He asked what sign. I said: Slow Children At Play.", "work humor"),
    ("We don't have a company culture. We have a company survival situation.", "work humor"),
    ("According to my stress ball, I should be calmer. The stress ball is wrong.", "work humor"),
    ("I'm not a morning person. Or an afternoon person. Evenings are looking dicey too.", "work humor"),
    ("The closest I've been to a raise is when I stood up at my desk.", "work humor"),
    ("Hard work never killed anyone, but why risk it?", "work humor"),
    ("I love my job. It's the work I hate.", "work humor"),
